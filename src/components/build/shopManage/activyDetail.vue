<template>
  <div class="addGoods goodsDetail">
    <p class="return" @click="closeWin">返回上一级</p>
    <div>
      <el-form :model="goodsForm" :rules="goodsFormRules">
        <div class="step" v-if="isShowDrainage">
          <div class="content-panel">
            ...
            <el-form-item>
              <el-button @click.native="openDrainage" style="float:left;" disabled="disabled">{{goodsForm.drainage}}</el-button>
            </el-form-item>
